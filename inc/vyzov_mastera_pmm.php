...
//$comments = check_in($_POST["comments"], "Вы забыли написать телефон!");
...
$comments_to_myemail = "Телефон: $phone (Заказ по ПОСУДОМОЙКАМ от bosch-service-moscow.ru)
...
include '../callback-phone-order-dishwasher.html'
